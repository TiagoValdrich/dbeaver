...
public abstract class MySQLNativeToolHandler<SETTINGS extends AbstractNativeToolSettings<BASE_OBJECT>, BASE_OBJECT extends DBSObject, PROCESS_ARG>
    ...
    @Override
    protected boolean doExecute(DBRProgressMonitor monitor, DBTTask task, SETTINGS settings, Log log, boolean hasOnSuccess) throws DBException, InterruptedException {
        try {
            return super.doExecute(monitor, task, settings, log, hasOnSuccess);
        } finally {
